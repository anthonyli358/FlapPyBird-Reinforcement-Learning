...
def plot_performance(
    agent_states: Dict[str, List], window=50, xlim=None, ylim=None, logy=False
) -> None:
    """Plot the training performance."""
    episodes, scores, max_scores = (
        agent_states["episodes"],
        agent_states["scores"],
        agent_states["max_scores"],
    )
    fig, ax = plt.subplots()
